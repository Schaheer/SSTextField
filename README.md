# SSTextField
Custom TextField for iOS using UIKit
...
### Storyboards:
If you're using Storyboards/Interface Builder you can create a `SSTextField` instance by adding a normal UIView to your Storyboard, and then manually changing the view's class to `SSTextField` in the "Custom Class" field of the Identity Inspector tab on the Utilities panel (the right-side panel).

<img src="Metadata/storyboards_config.png" width="300">

### Customisation:
`SSTextField` includes support for IBInspectable, to allow configuration of the textfields ContentType, KeyboardType, ValidationType and colours for the text, placeholder, error message and line inside Interface Builder/Storyboards
